...
int main() {
    ...
    scanf("%lld", &privateA);
    printf("Enter Basyal's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Sneha's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("Basyal's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Sneha: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by Basyal: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
![image](https://github.com/user-attachments/assets/3ad99c13-2f8e-4e19-a1b8-b80783e15cbf)
